...
Event OnPageReset(String Page)
	...
	ElseIf(Page == "$Yam_pAdultFrames")
		...
		; AddSliderOptionST("SLAllowedweight", "$Yam_afFrameSexLab", iSLweight, "{0}", getFlag(SLThere))
		; AddSliderOptionST("FGAllowedweight", "$Yam_afFrameFlowergirls", iFGweight, "{0}", getFlag(Game.GetModByName("FlowerGirls SE.esm") != 255))
		; AddSliderOptionST("OStimAllowedweight", "$Yam_afFrameOStim", iOStimweight, "{0}", getFlag(Game.GetModByName("OStim.esp") != 255))
...
Event OnHighlightST()
	...
	ElseIf(option[0] == "SLAllowed" || option[0] == "SLAllowedweight")  ; Anim Frames
		SetInfoText("$Yam_afFrameSexLab_Highlight")
	ElseIf(option[0] == "FGAllowed" || option[0] == "FGAllowedweight")
		SetInfoText("$Yam_afFrameFlowergirls_Highlight")
	ElseIf(option[0] == "OStimAllowed" || option[0] == "OStimAllowedweight")
		SetInfoText("$Yam_afFrameOStim_Highlight")
